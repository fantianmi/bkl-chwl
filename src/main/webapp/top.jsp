  ...
  <div class="container" style="margin-bottom: 0px;">
    <div class="navbar-header" style="margin:0;width:100% !important;">
    	<div class="nav-wrap-left" style="float:left !important;;text-align: left !important;" id="top_back_button">
            <a class="react" href="javascript:history.back()" style="font-size: 1.6rem;color:#fff;padding-right: 1rem !important;"><i class="iconfont">&#xf0015;</i>返回</a>
        </div>
    	<div class="head_title" id="head_title" style="margin-left:.5rem"></div>
    	<div class="head_button" style="border-right:1px solid #4D545C " id="top_qr_button"><a href="javascript:void(0);" onclick="scanQR()" class="logo-home btn btn-default noradius" style="border-top-left-radius: 4px !important;;border-bottom-left-radius: 4px !important;;margin-right:0px;"><i class="iconfont" id="searchbar">&#xe6fb;</i></a></div>
    	...
    	<div class="nav-wrap-left" style="float:right !important;;text-align: right !important;">
